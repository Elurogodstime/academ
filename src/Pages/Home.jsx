  ...
  return (
    ...
    <div className='heros'>
        {Hero.map(Heros=>
         ...
         {Hero.map(Heros=>
            <p className='hero-title  text-8xl  flex-wrap font-bold text-center   ' key={Hero.Text}>Learn,Relearn,Build <br />  and Deploy with <span className='text-amber-300'>Technologies...</span> {Heros.Text}</p>
        )}
